        ...
        <div className="flex flex-col min-h-screen bg-background">
          ...
          <main className="flex-grow font-inter">
            <div className="grid grid-cols-1 grid-rows-[100px_minmax(0,1fr)] h-full md:grid-cols-[240px_minmax(0,1fr)]">
              <div className="row-start-1 row-span-2 hidden shrink-0 border-r border-gray-950/10 md:sticky md:block md:top-14 h-[calc(100vh-3.5rem)] overflow-y-auto">
                <div className="flex flex-col p-4"> {/* Added padding for content */}
