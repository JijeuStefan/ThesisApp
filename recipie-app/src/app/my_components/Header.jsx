            ...
            <div className="flex flex-row items-center justify-between h-14 px-8 gap-8">
                <div className="flex flex-row items-center gap-2">
                    <svg 
                        ...
                        viewBox="0 0 500 500">
                        <g  
                            transform="matrix(0.999999, 0.001496, -0.001496, 0.999999, -131.344787, 7.468525)" 
                            style= {{transformOrigin: "381.345px 242.531px"}} >
                                <g 
                                    transform="matrix(3.394623, 0, 0, 3.465488, 172.780272, 30.702631)">
                                    ...
                                    style={{ fill: "rgb(183, 83, 42)", paintOrder: "fill" }}/>
                                </g>
                        </g>
                    </svg>
                    <span className="text-2xl font-mono font-bold ">visionBite</span>
                </div>
                <div className="flex items-center gap-6 font-sans">
                    ...
                    <a href="https://github.com/JijeuStefan">
                        <svg 
                            xmlns="http://www.w3.org/2000/svg" 
                            width="17" height="17" 
